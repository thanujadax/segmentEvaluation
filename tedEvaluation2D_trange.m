...
reconstructionDir = '/home/thanuja/RESULTS/cvpr/TED2/rfc_stc';
...
outputRoot = '/home/thanuja/RESULTS/cvpr/TED2/tedOut/rfc_stc';
gtType = 'png';
rType = 'png';
...
if(numGT ~= numRec)
    ...
    for j=1:numel(theta)
        outputFile = fullfile(outputRoot,sprintf('%03d.txt',j));
        for i=1:numGT
        ...
        unixCommand = sprintf(...
            ...
            '--groundTruth=%s '...
            '--reconstruction=%s '...
            '--evaluation.maxBoundaryShift=%d >> %s '],...
            tedCommand,...
